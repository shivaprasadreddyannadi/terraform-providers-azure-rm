output "service_id" {
  description = "The ID of the API Management Service you created"
  value       = azurerm_api_management.apim_service.id
}

output "gateway_url" {
  description = "The URL of the Gateway for the API Management you Service"
  value       = azurerm_api_management.apim_service.gateway_url
}

output "service_public_ip_addresses" {
  description = "The Public IP addresses of the API Management you Service"
  value       = azurerm_api_management.apim_service.public_ip_addresses
}

output "api_outputs" {
  description = "The IDs, state, and version outputs of the APIs you created"
  value = {
...
output "product_ids" {
  description = "The ID of the Product you created"
  value       = azurerm_api_management_product.product.id
}

output "product_api_ids" {
  description = "The ID of the Product/API association you created"
  value       = azurerm_api_management_product_api.product_api.id
}

output "product_group_ids" {
  description = "The ID of the Product/Group association you created"
